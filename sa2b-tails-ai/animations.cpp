...
void PSetMotion_SetStartFrame(CharAnimInfo_* result)
{
    ...
    {
        v2 = CharacterAnimations[result->Animations[result->Current].AnimNum].Animation->nbFrame;
        result->acttimer = 0;
...
void PTerminateInterpolateMotion(CharAnimInfo_* a1)
{
    ...
    for (i = (__int16)CharacterAnimations[a1->Animations[a1->Next].AnimNum].Count; i > 0; --i)
    {
        if (*(DWORD*)mdata)
        {
...
void PlayAnimationThing_r(CharAnimInfo_* charAnimInfo)
{
    ...
    else
    {
        ...
        if (v7->mtnmode == 11)
        {
            ...
            if (v8->mtnmode == 11)
            {
                v91 = (float)CharacterAnimations[v8->AnimNum].Animation->nbFrame;
                v93 = (float)CharacterAnimations[v7->AnimNum].Animation->nbFrame;
                v9 = v93;
    ...
    case 3:
        ...
        v20 = &CharacterAnimations[v19[v22].AnimNum].Animation->nbFrame;
        ...
        for (; charAnimInfo->nframe < 0.0; charAnimInfo->nframe = (double)*v20 + charAnimInfo->nframe)
        {
            ;
        }
        return;
    case 4:
        ...
        v37 = &v36[v39];
        v42 = CharacterAnimations[v40].Animation;
        v81 = v41;
    ...
    case 5:
        ...
        v47 = CharacterAnimations[v43[v45].AnimNum].Animation;
        v44 = &v43[v45];
        v82 = v46;
    ...
    case 6:
        ...
        v66 = CharacterAnimations[v65->AnimNum].Animation;
    ...
    case 9:
        ...
        v57 = CharacterAnimations[v53[v55].AnimNum].Animation;
        v54 = &v53[v55];
        v85 = v56;
    ...
    case 10:
        ...
        v25 = &CharacterAnimations[v24[v27].AnimNum].Animation->nbFrame;
        ...
        for (; charAnimInfo->nframe < 0.0; charAnimInfo->nframe = (double)*v25 + charAnimInfo->nframe)
        {
            ;
        }
        return;
    case 11:
        ...
        v29 = &CharacterAnimations[v31->AnimNum].Animation->nbFrame;
        ...
        for (; charAnimInfo->nframe < 0.0; charAnimInfo->nframe = (double)*v29 + charAnimInfo->nframe)
        {
            ;
        }
        return;
    case 12:
        v33 = CharacterAnimations[charAnimInfo->Animations[nextAnimCopy].AnimNum].Animation;
    ...
    LABEL_38:
        ...
        goto LABEL_74;
    case 13:
        v67 = &CharacterAnimations[charAnimInfo->Animations[nextAnimCopy].AnimNum].Animation->nbFrame;
        v89 = (float)*v67;
        v68 = v89;
        ...
        for (; charAnimInfo->nframe < 0.0; charAnimInfo->nframe = (double)*v67 + charAnimInfo->nframe)
        {
            ;
        }
        return;
